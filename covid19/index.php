...
<div class="container-fluid bg-light p-5 text-center my-3">
    ...
    <h5 class="lead">Keep Track of all cases in the world</h5>
...
<div class="container-fluid bg-light p-2 my-3 text-center">
    <h3 class="text-info">Prevention is the Cure</h5>
